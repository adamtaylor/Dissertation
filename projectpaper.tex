    ...
    \begin{table}
        ...
        \begin{center}
            \begin{tabular}{ | l | c | c | c | c | c | }
                ...
                Acunetix AspNet & 0 & 0 & 7 & 0 & 5 \\ \hline
                Acunetix TestPHP & 0 & 0 & 28 & 0 & 1 \\ \hline
                Cenzic Crackme & 0 & 0 & 17 & 0 & 0 \\ \hline
                HP zerowebappsecurity & 0 & 0 & 31 & 0 & 6 \\ \hline
                IBM Testfire & 0 & 0 & 24 & 0 & 4 \\ \hline
                NTO Webscantest & 0 & 0 & 47 & 0 & 0 \\
                \hline
            \end{tabular}
        \end{center}
    \end{table}
...
\begin{center}
    \begin{table}
        ...
        \begin{center}
            \begin{tabular}{ | l | c | c | }
                \hline
                Status & Vulns Type & \% File \\ \hline
                Verified & XSS & /search.aspx \\ \hline
                Verified & XSS & /search.aspx \\ \hline
                Verified & XSS & /search.aspx \\ \hline
                Verified & XSS & /search.aspx \\ 
                \hline
            \end{tabular}
        \end{center}
    \end{table}
...
\begin{center}
    \begin{table}
        \caption{NTO Webscantest Scan Result}
        \begin{center}
            \begin{tabular}{ | l | c | c | }
                \hline
                Status & Vulns Type & \% File \\ \hline
